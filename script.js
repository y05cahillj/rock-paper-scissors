...
function getResult() {
  ...
  if (userScore>=5) {
    winner = "You won the entire game!"
  }
...
// we will need to create a function / add a loop event to this (max of 5 per game), and also add a reset button

//function keeping track of winner
